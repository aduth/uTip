...
(function() {
  ...
  (function($, window, document) {
    var defaults, plugin, uTip, util, _ref;
    util = {
      ...
      uTip.prototype.bindEvents = function() {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          util.on(element, "mouseover", function(e) {
            ...
            left = target.offsetLeft + target.offsetWidth / 2 - _this.tip.offsetWidth / 2;
            if (left < 0) {
              left = 0;
            }
            top = target.offsetTop - _this.tip.offsetHeight - 8;
            if (top < 0) {
              top = 0;
            }
